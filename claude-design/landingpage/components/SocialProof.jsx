...
// EDA Social Proof / Testimonials
function SocialProof({ accentColor }) {
  ...
  return (
    <section id="casos" style={{ padding: '100px 24px' }}>
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 60 }}>
          ...
          }}>Negocios que ya están creciendo con EDA</h2>
        </div>
        ...
        <div className="testimonials-grid" style={{
          ...
          {testimonials.map((t, i) => (
            ...
            onMouseEnter={e => e.currentTarget.style.borderColor = `${green}30`}
            onMouseLeave={e => e.currentTarget.style.borderColor = 'rgba(255,255,255,0.07)'}
            >
              {/* Stars */}
              <div style={{ display: 'flex', gap: 3 }}>
                {[...Array(5)].map((_, s) => (
                  <svg key={s} width="13" height="13" viewBox="0 0 13 13" fill={green}>
              ...
              <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
                <div style={{
                  ...
                  fontFamily: 'Syne, sans-serif', fontWeight: 700, fontSize: 13, color: t.color,
                  flexShrink: 0,
                }}>{t.initials}</div>
                <div>
                  <div style={{ fontFamily: 'Inter, sans-serif', fontWeight: 600, fontSize: 13, color: '#fff' }}>{t.name}</div>
        ...
        <p style={{
          ...
          {/* Testimonios reales se cargarán dinámicamente desde CMS */}
